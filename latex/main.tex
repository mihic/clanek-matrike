...
Intel MKL
\end{itemize}
%% TODO vec in brez alinej verjetno??
...
%% TODO cache; a je to previlno is tehnicnega vidika 
%% TODU the computer will have to make jumps through the memory and will not optimally use the cache; verjetno treba drugace
...
%%TODU code is compiled; a je to tehnicno pravilno, a to res kaj vpliva na vse skupaj
